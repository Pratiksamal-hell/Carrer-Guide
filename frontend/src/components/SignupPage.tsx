...
import { Sparkles, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2, User, CheckCircle2 } from 'lucide-react'
        ...
        <div className="bg-card rounded-2xl shadow-lg shadow-primary/5 border border-border p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              {password && (
                <div className="mt-3 p-3 bg-secondary/30 rounded-xl space-y-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-input bg-background text-foreground hover:bg-secondary/50 focus:outline-none focus:ring-2 focus:ring-ring transition-all"
            >
